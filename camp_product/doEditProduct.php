...
if (!in_array(1, $normalPicArr)) {
    if ($normalPic["error"] == 4) {
        ...
        foreach ($normalPic["name"] as $key => $value) {
            ...
            echo $productId, $mainPic_num, $value . "<br>";

            $normalPicSql = "INSERT INTO images (product_id, product_mainPic, path) VALUES ('$productId','0','$value')";
...
header("location: ./product_detail.php?product_id=$productId");
